...
?>" />
		...
		<p>
		   <label for="<?php
        echo $this->get_field_id('summary');
?>"><?php
        _e('Summary (optional):', 'woothemes');
?></label>
			<textarea name="<?php
        echo $this->get_field_name('summary');
?>" class="widefat" id="<?php
        echo $this->get_field_id('summary');
?>"><?php
...
?></textarea>
		...
		<p>
		   <label for="<?php
        echo $this->get_field_id('button_txt');
?>"><?php
        _e('Button Text (optional):', 'woothemes');
?></label>
       <input type="text" name="<?php
        echo $this->get_field_name('button_txt');
?>"  value="<?php
        echo esc_attr($button_txt);
?>" class="widefat" id="<?php
        echo $this->get_field_id('button_txt');
?>" placeholder="Default text is Subscribe via Email" />
	  </p>
		<p>
		   <label for="<?php
...
?>" class="widefat" id="<?php
        echo $this->get_field_id('button_color');
?>" placeholder="For hex colors don't forget to add #."/>
	  </p>
		<p>
		   <label for="<?php
        echo $this->get_field_id('m_title');
?>"><?php
        _e('Popup Title:', 'woothemes');
?></label>
       <input type="text" name="<?php
        echo $this->get_field_name('m_title');
?>"  value="<?php
        echo esc_attr($m_title);
?>" class="widefat" id="<?php
        echo $this->get_field_id('m_title');
?>"/>
	  </p>
		<p>
		   <label for="<?php
        echo $this->get_field_id('m_summary');
?>"><?php
        _e('Popup Summary:', 'woothemes');
?></label>
			<textarea name="<?php
        echo $this->get_field_name('m_summary');
?>" class="widefat" id="<?php
        echo $this->get_field_id('m_summary');
?>"><?php
        echo esc_textarea($m_summary);
?></textarea>
		</p>
		<p>
		   <label for="<?php
        echo $this->get_field_id('m_img');
?>"><?php
        _e('Popup Image URL:', 'woothemes');
?></label>
       <input type="text" name="<?php
        echo $this->get_field_name('m_img');
?>"  value="<?php
        echo esc_attr($m_img);
?>" class="widefat" id="<?php
        echo $this->get_field_id('m_img');
?>"/>
		...
		<p>
		   <label for="<?php
        echo $this->get_field_id('privacy_policy');
?>"><?php
        _e('Privacy Policy:', 'woothemes');
?></label>
       <input type="text" name="<?php
        echo $this->get_field_name('privacy_policy');
?>"  value="<?php
        echo esc_attr($privacy_policy);
?>" class="widefat" id="<?php
        echo $this->get_field_id('privacy_policy');
?>" placeholder="Set to override default"/>
	  </p>
		<?php
    }
       ...
       <div id="overlay">
        <div id="gfb_newsletter_signup_form">
          ...
          <?php
            if ($m_img) {
?>
            <img class="gfb_ebook_img" src="<?php
                echo $m_img;
?>" style="float:left; width:30%;min-width:50px;max-width:200px;max-height:250px;min-height:100px;"/>
          <?php
            }
?>
          <div id="" style="<?php
...
?> none repeat scroll 0%" ><?php
            _e('Sign Up', 'woothemes');
?></button>
